...
public class GuestAddRequest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_guest_add_request);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent back=new Intent(GuestAddRequest.this, RequestList.class);
                startActivity(back);
            }
        });
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(Request))
                {
                    ...
                    Toast.makeText(GuestAddRequest.this, "Please add a request.", Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    Toast.makeText(GuestAddRequest.this, "Request sent!", Toast.LENGTH_SHORT).show();
                    Intent list = new Intent(GuestAddRequest.this, RequestList.class);
                    startActivity(list);
                }
            }
        });
